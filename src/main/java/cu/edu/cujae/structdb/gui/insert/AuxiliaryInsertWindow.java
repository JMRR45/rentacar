...
public class AuxiliaryInsertWindow extends JDialog {
    ...
    public AuxiliaryInsertWindow(Object type, Window owner) {
        ...
        switch (this.type) {
            ...
            case brand -> this.setTitle("Registrar Marcas de los Autos");
            case paymethod -> this.setTitle("Registrar Método de Pago");
        }
    }
    ...
    private void ok(ActionEvent e) {
        ...
        switch (type) {
            ...
            case brand -> message = "Marca registrada";
            case paymethod -> message = "Método de pago creado";
            case country -> message = "País registrado";
            case category -> message ="Categoría de licencia registrada";
        }
